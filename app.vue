...
useHead({
  ...
  meta: [
    ...
    {
      property: "og:image",
      content: "https://www.happy-tours.gr/blue-lagoon-beach.jpg", // Replace with your actual image URL
    },
    {
      property: "og:url",
    ...
    {
      name: "twitter:image",
      content: "https://www.happy-tours.gr/blue-lagoon-beach.jpg", // Same as OG image
    },
    {
      name: "twitter:card",
