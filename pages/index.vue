<template>
  <v-app>
    ...
    <v-container id="cruiseOptions" class="my-12">
      <v-row>
        <v-col cols="12" class="text-center mb-6">
          ...
          <p class="subtitle-1">
            Choose the perfect cruise for your adventure.
          </p>
        </v-col>
      </v-row>
    ...
    <v-dialog v-model="dialog" max-width="400">
      <v-card>
        <v-card-title class="headline"
          >Book Your Cruise: {{ selectedCruise.title }}</v-card-title
        >
        <v-card-text>
        ...
        <v-card-actions class="d-flex flex-column pa-4">
          ...
          >
          <v-btn color="secondary" block @click="sendEmail"
            >Send via Email</v-btn
          >
        </v-card-actions>
        <v-card-actions>
          <v-btn
    ...
    <!-- Footer Section -->
    <v-footer color="grey darken-4" class="text-white text-center">
      <v-container>
        <v-row>
          <v-col>
